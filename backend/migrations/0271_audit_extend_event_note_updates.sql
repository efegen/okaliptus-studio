-- 0270'te event_notes düzenleme/silme kazandı; events.service.ts artık
-- 'event_note_updated' ve 'event_note_deleted' action'larıyla insertAuditLog
-- çağırıyor ama bu değerler audit_logs CHECK kısıtında yoktu. Eski migration'lar
-- in-place düzenlenmez; bu dosya 0269'daki tam listeyi korur + genişletir.
