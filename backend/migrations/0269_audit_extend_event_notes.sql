-- events.service.ts addEventNote() 'event_note_created' action'ıyla ve
-- 'event_note' entity_type'ıyla insertAuditLog çağırıyor ama bu değerler
-- audit_logs CHECK kısıtlarında yoktu. Eski migration'lar in-place
-- düzenlenmez; bu dosya 0267'deki (action için en güncel) ve 0262'deki
-- (entity_type için en güncel) tam listeleri korur + genişletir.
