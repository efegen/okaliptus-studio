-- events.service.ts deleteEvent() (Etkinlik ayarları → "Etkinliği sil") artık
-- 'event_deleted' action'ıyla insertAuditLog çağırıyor ama bu değer
-- audit_logs CHECK kısıtında yoktu. Eski migration'lar in-place düzenlenmez;
-- bu dosya 0262'deki tam listeyi korur + genişletir.
